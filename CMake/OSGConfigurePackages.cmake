    ...
    IF(NOT OSG_USE_OSGSUPPORT_LIBS OR NOT GLUT_FOUND)
      ...
      ELSE(GLUT_FOUND)
        ...
        ELSE(WIN32)
          ...
          IF(NOT GLUT_INCLUDE_DIR AND GLUT_INCLUDE_DIRS)
...
MACRO(OSG_CONFIGURE_BOOST)
  ...
  SET(Boost_ADDITIONAL_VERSIONS "1.54.0" 
    ...
    IF(NOT OSG_ENABLE_C++11_STD_ATOMICS)
        LIST(APPEND OSG_GLOBAL_DEP_DEFS "BOOST_NO_CXX11_HDR_ATOMIC=1")
    ENDIF()
    ...
    IF(Boost_FOUND)
        ...
        LIST(APPEND OSG_GLOBAL_DEP_DEFS "BOOST_SP_USE_SPINLOCK")
        LIST(APPEND OSG_GLOBAL_DEP_DEFS "BOOST_SYSTEM_NO_DEPRECATED=1")
...
MACRO(OSG_CONFIGURE_QHULL)
    ...
    ELSE(OSG_ENABLE_QHULL)
	OSG_SET(OSG_WITH_QHULL 0)
    ENDIF(OSG_ENABLE_QHULL)
